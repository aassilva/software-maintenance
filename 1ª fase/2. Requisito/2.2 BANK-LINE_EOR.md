...
<b>UC7.Pagamento de Contas e Boletos</b></br>
<p>Pré-condições: </br>
   - O usuário deve ter baixado o aplicativo</br>
   - O usuário deve estar logado no sistema</br></p>
<p>Fluxo: </br>
...
<b>UC8.Transferências Bancárias</b></br>
<p>Pré-condições: </br>
   - O usuário deve ter baixado o aplicativo</br>
   - O usuário deve estar logado no sistema</br></p>
<p>Fluxo: </br>
...
<b>UC9. Agendamento de Pagamento</b></br>
<p>Pré-condições: </br>
   - O usuário deve ter baixado o aplicativo</br>
   - O usuário deve estar logado no sistema</br></p>
<p>Fluxo: </br>
