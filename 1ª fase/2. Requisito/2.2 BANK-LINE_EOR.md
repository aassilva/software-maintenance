...
### 3.2 Domínio do problema e contexto de sua aplicação
O projeto BANK-LINE visa ao desenvolvimento de um sistema que realiza serviços basicos tais como: consultar saldo, consultar extrato, realizar pagamento de boletos, realizar transferencia entre contas e outras. O objetivo é simplificar as operações bancarias basicas, garantido segurança ao usuário. O principal artefato em estudo do BANK-LINE é composto por um software, que possibilitará, por intermédio do uso de comunicação via internet desktop, a realização de transações bancarias, após seu cadastro, validação e autenticação.
<p>
...
<p>Fluxo: </br>	  
	...
	- O usuário administrador deverá informar o nome ou o número de conta, nos respectivos campos, do usuário a ser alterado</br>
	- O usuário administrador deverá escolher entre um dos resultados da lista apresentada</br>
	- O usuário administrador deverá clicar no botão "Emitir relatório" na parte inferior a resposta desejada</br>
	- Fim do caso de uso</br></p>
<p>Pós-condições:</br> 
	- O sistema apresenta o relátorio</br></p>
	- Usuário está com status inativo no sistema

<b>UC16. Suspender Usuário</b></br>
<p>Pré-condições: </br>
	- O usuário está cadastrado no sistema</br></p>
	- O usuário está com status "Ativo"
<p>Fluxo: </br>	  
	- O sistema identifica que o usuário digitou sua senha icorreta por 3 vezes</br>
	- O sistema alterar o status do usuário de ativo para suspenso</br>
	- Fim do caso de uso</br></p>
<p>Pós-condições:</br> 
	- Estado do usuário passa a ser "Suspenso"</br></p>
	- Usuário está com status inativo no sistema
...
<p>Fluxo: </br>	  
	...
	- O usuário administrador deverá informar o nome ou o número de conta, nos respectivos campos, do usuário a ser consultado</br>
	- O usuário administrador deverá escolher entre um dos resultados da lista apresentada</br>
	- O usuário administrador deverá clicar no botão "Bloquear Usuário" de cor vermelha ao lado do usuário escolhido.</br>
	- O usuário administrador deverá informar a justificativa para o bloqueio do usuário e clicar em OK.</br>
	- Deverá exibir uma mensagem na tela informando que o usuário foi bloqueado</br>
	- O botão que antes o nome era Bloquear Usuário deverá ser alterado para Desbloquear Usuário e sua cor deverá ser alterada para verde</br>
	- Fim do caso de uso</br></p>
<p>Pós-condições:</br> 
	- Estado do sistema inalterado</br></p>
...
<p>Pré-condições: </br>
	- O usuário está cadastrado no sistema</br>
  	- O usuário está com status diferente de "Inativo"
<p>Fluxo: </br>	  
	- O usuário administrador deverá selecionar a aba "Consultar Usuário"</br>
	- O usuário administrador deverá informar o nome ou o número de conta, nos respectivos campos, do usuário a ser consultado</br>
	- O usuário administrador deverá escolher entre um dos resultados da lista apresentada</br>
	- O usuário administrador deverá clicar no botão "Inativar Usuário" de cor preto ao lado do usuário escolhido.</br>
	- O usuário administrador deverá informar a justificativa para inativar o usuário e clicar em OK.</br>
	- Deverá exibir uma mensagem na tela informando que o usuário foi inativado</br>
	- O botão que antes o nome era "Inativar Usuário" deverá ser alterado para "Ativar Usuário" e sua cor deverá ser alterada para verde</br>
	- Fim do caso de uso</br></p>
<p>Pós-condições:</br> 
	- Usuário está com status inativo no sistema
	- Estado do sistema inalterado</br></p>
...
<p>Pré-condições: </br>
	- O usuário deve ter baixado o aplicativo</br>
	- O usuário deverá está cadastrado no </br>
   	- O usuário deve estar logado no sistema</br>
  	- O usuário realizar alguma alterção no sistema</br>
<p>Fluxo: </br>	  
	- O usuário realizar uma ação no sistema</br>
	- O sistema valida ação realizada pelo usuário</br>
	- O sistema armazena dados no Banco de Dados</br>
	- Fim do caso de uso</br></p>
<p>Pós-condições:</br> 
	- Os dados da alteração é armazenado no Banco de Dados
	- Estado do sistema inalterado</br></p>

<b>UC20. Consultar Histórico</b></br>
<p>Pré-condições: </br>
	- O usuário deve ter baixado o aplicativo</br>
	- O usuário deverá está cadastrado no sistema</br>
   	- O usuário deve estar logado no sistema</br>
<p>Fluxo: </br>	  
	- O usuário realizar uma ação no sistema que demanda a consulta de histórico</br>
	- O sistema valida ação realizada pelo usuário</br>
	- O sistema apresenta o histórico solicitado</br>
	- Fim do caso de uso</br></p>
<p>Pós-condições:</br> 
	- Os dados solicitado são apresentado</br>
	- Estado do sistema inalterado</br></p>
...
### 7.1 Interfaces validadas para Sistema Desktop

<<< Aqui colocar as Telas do Computador. >>>


### 7.2 Interfaces futuras para Sistema Mobile

<<< Aqui colocar as Telas do Mobile >>>
